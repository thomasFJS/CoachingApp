...
def workouts():
	...
	workouts = TrainingData.query.order_by(TrainingData.date)
...
class TrainingData(db.Model):
	id = db.Column(db.Integer, primary_key=True)
	heart_rate_max = db.Column(db.String(20), nullable=True)
	heart_rate_min = db.Column(db.String(20), nullable=True)
	heart_rate_avg = db.Column(db.String(20), nullable=True)
	calories = db.Column(db.Integer, nullable=True)
	active_calories = db.Column(db.Integer, nullable=True)
	active_steps = db.Column(db.Integer, nullable=True)
